...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            <form action="RealizarVendaController?acao=confirmar">

                <div class="row">
                    <div class="col-sm-12 page-header">
                        <h1 class="header">Realizar Venda</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="cliente" name="cliente">
                                <c:forEach items="${clientes}" var="umCliente">
                                    <option value="${umCliente.idCliente}">${umCliente.nome}</option>  
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="convenio" name="convenio">
                                <c:forEach items="${convenios}" var="umConvenio">
                                    <option value="${umConvenio.idConvenio}">${umConvenio.razaoSocial}</option>  
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="produto" name="produto">
                                <c:forEach items="${produtos}" var="umProduto">
                                    <option value="${umProduto.idProduto}" 
                                            ...
                                            data-preco="${umProduto.precoVenda}">${umProduto.descricao}</option>  
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">   
                            ...
                            <input type="text" name="txtDtVenda" required class="form-control" value="${venda.dtVenda}">
                        </div>      
                        <div class="form-group">
